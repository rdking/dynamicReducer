 ...
 * @param {Array[string]} fields - Names of the action payload fields.
 ...
 * where all related registration info will be held. Used to later remove all
 * associated state, actions, and reducers.
 * @returns {Object} returns the key data needed to fully connect Dynamic
 * Reducer into Redux
 * @prop {Function} retval.ActionState - Use as value for mapStateToProps in
 * the connect() call.
 * @prop {Object} retval.ActionBuilders - Use as substitute for mapDispatchToProps
 */
